// Implementing and playing Minesweeper using c++
...
int SIDE ;  //board side length
int MINES ; // number of mine on the board
...
// function to check whether given cell (row, cell)
// has a mine or not.
